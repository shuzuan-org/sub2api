...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	oauthAuthorizationService := service.NewOAuthAuthorizationService(oauthClientRepository, oauthAuthorizationCodeRepository, oauthRefreshTokenRepository, userRepository, oauthAccessTokenDenylist, configConfig)
