...
var DefaultAntigravityModelMapping = map[string]string{
	// Claude 白名单
	"claude-opus-4-8":            "claude-opus-4-8",            // 最新旗舰
	"claude-opus-4-7":            "claude-opus-4-7",            // 上一旗舰
...
var DefaultBedrockModelMapping = map[string]string{
	...
	// claude-opus-4-7: AWS Bedrock research preview, model ID unverified — not in official supported models list
