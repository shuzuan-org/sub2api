...
func (s *billingCacheMissStub) GetSubscriptionCache(ctx context.Context, userID, planID int64) (*SubscriptionCacheData, error) {
	return nil, errors.New("cache miss")
}

func (s *billingCacheMissStub) SetSubscriptionCache(ctx context.Context, userID, planID int64, data *SubscriptionCacheData) error {
	return nil
}

func (s *billingCacheMissStub) UpdateSubscriptionUsage(ctx context.Context, userID, planID int64, cost float64) error {
	return nil
}
