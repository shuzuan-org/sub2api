...
func (b *billingCacheWorkerStub) GetSubscriptionCache(ctx context.Context, userID, planID int64) (*SubscriptionCacheData, error) {
	return nil, errors.New("not implemented")
}

func (b *billingCacheWorkerStub) SetSubscriptionCache(ctx context.Context, userID, planID int64, data *SubscriptionCacheData) error {
	atomic.AddInt64(&b.subscriptionUpdates, 1)
	return nil
}

func (b *billingCacheWorkerStub) UpdateSubscriptionUsage(ctx context.Context, userID, planID int64, cost float64) error {
	atomic.AddInt64(&b.subscriptionUpdates, 1)
	return nil
}
...
func TestBillingCacheServiceQueueHighLoad(t *testing.T) {
	...
	svc.QueueUpdateSubscriptionUsage(1, 9, 1.5)
