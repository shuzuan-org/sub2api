  ...
  <AppLayout>
    <TablePageLayout>
      ...
      <template #table>
        <DataTable :columns="columns" :data="groups" :loading="loading">
          ...
          <!-- billing_type column removed: subscription_type no longer exists on Group -->
    ...
    >
      <form id="create-group-form" @submit.prevent="handleCreateGroup" class="space-y-5">
        ...
        <!-- Subscription Configuration removed: subscription_type and limits now live in SubscriptionPlan -->
...
// 无效请求兜底分组选项（创建时）- 仅包含 anthropic 平台、未配置兜底的分组
