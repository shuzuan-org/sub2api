export default {
  ...
  keys: {
    ...
    quotaAmount: 'Quota Amount (U)',
    quotaAmountPlaceholder: 'Enter quota limit in U',
    ...
    resetUsage: 'Reset',
    rateLimit5h: '5-Hour Limit (U)',
    rateLimit1d: 'Daily Limit (U)',
    rateLimit7d: '7-Day Limit (U)',
  ...
  usage: {
    ...
    accountMultiplier: 'Account discount',
    avgDuration: 'Avg Duration',
  ...
  admin: {
    ...
    users: {
      ...
      groupConfigHint: 'Configure custom discounts for user {email} (overrides group defaults)',
      exclusiveGroups: 'Exclusive Groups',
      publicGroups: 'Public Groups (Default Available)',
      defaultRate: 'Default Discount',
      customRate: 'Custom Discount',
    ...
    groups: {
      ...
      description: 'Manage API key groups and discounts',
      searchGroups: 'Search groups...',
      ...
      rateMultiplierHint: 'Discount for this group (1.0 = original price, 0.5 = half price)',
      ...
      exclusiveTooltip: {
        ...
        example: 'Use case:',
        exampleContent: 'Public group discount is 0.8. Create an exclusive group with 0.7 discount, manually assign VIP users to give them better pricing.'
      },
      ...
      rateMultipliers: 'Discounts',
      rateMultipliersTitle: 'Group Discounts',
      addUserRate: 'Add User Discount',
      searchUserPlaceholder: 'Search user email...',
      noRateMultipliers: 'No user discounts configured',
      rateUpdated: 'Discount updated',
      rateDeleted: 'Discount removed',
      rateAdded: 'Discount added',
      clearAll: 'Clear All',
      confirmClearAll: 'Are you sure you want to clear all discount settings for this group? This cannot be undone.',
      rateCleared: 'All discounts cleared',
      batchAdjust: 'Batch Adjust Discounts',
      multiplierFactor: 'Factor',
      applyMultiplier: 'Apply',
      rateAdjusted: 'Discounts adjusted successfully',
      rateSaved: 'Discounts saved',
      finalRate: 'Final Discount',
      ...
      subscription: {
        ...
        dailyLimit: 'Daily Limit (U)',
        weeklyLimit: 'Weekly Limit (U)',
        monthlyLimit: 'Monthly Limit (U)',
      ...
      soraPricing: {
        ...
        image360: 'Image 360px (U)',
        image540: 'Image 540px (U)',
        video: 'Video (standard) (U)',
        videoHd: 'Video (Pro-HD) (U)',
    ...
    accounts: {
      ...
      columns: {
        ...
        notes: 'Notes',
        priority: 'Priority',
        billingRateMultiplier: 'Billing Discount',
        weight: 'Weight',
        status: 'Status',
        schedulable: 'Schedulable',
    ...
    sms: {
      ...
      description: 'Configure Tencent Cloud SMS for phone verification',
      smsTencentEnabled: 'Enable SMS',
      smsTencentEnabledHint: 'Allow users to receive SMS verification codes',
      smsTencentSecretId: 'SecretId',
      smsTencentSecretIdPlaceholder: 'Enter Tencent Cloud SecretId',
      smsTencentSecretKey: 'SecretKey',
      smsTencentSecretKeyPlaceholder: 'Enter Tencent Cloud SecretKey',
      smsTencentSecretKeyHint: 'Already configured, leave empty to keep unchanged',
      smsTencentRegion: 'Region',
      smsTencentRegionPlaceholder: 'ap-guangzhou',
      smsTencentSdkAppId: 'SDK App ID',
      smsTencentSdkAppIdPlaceholder: 'Enter SMS App ID',
      smsTencentSignName: 'Sign Name',
      smsTencentSignNamePlaceholder: 'Enter SMS signature',
      smsTencentTemplateId: 'Template ID',
      smsTencentTemplateIdPlaceholder: 'Enter SMS template ID',
    },
  ...
  userSubscriptions: {
    ...
    insufficientBalanceRecharge: 'Insufficient balance. Please recharge in time.',
    dailyLimit: 'Daily limit',
    weeklyLimit: 'Weekly limit',
    monthlyLimit: 'Monthly limit',
    validity: 'Validity',
  ...
  onboarding: {
    ...
    admin: {
      ...
      groupManage: {
        ...
        description: '<div style="line-height: 1.7;"><p style="margin-bottom: 12px;"><b>What is a Group?</b></p><p style="margin-bottom: 12px;">Groups are the core concept of Sub2API, like a "service package":</p><ul style="margin-left: 20px; margin-bottom: 12px; font-size: 13px;"><li>🎯 Each group can contain multiple upstream accounts</li><li>💰 Each group has independent billing discount</li><li>👥 Can be set as public or exclusive</li></ul><p style="margin-top: 12px; padding: 8px 12px; background: #f0fdf4; border-left: 3px solid #10b981; border-radius: 4px; font-size: 13px;"><b>💡 Example:</b> You can create "VIP Premium" (high discount) and "Free Trial" (low discount) groups</p><p style="margin-top: 16px; color: #10b981; font-weight: 600;">👉 Click "Group Management" on the left sidebar</p></div>'
      },
      createGroup: {
      ...
      groupMultiplier: {
        title: '💰 3. Discount',
        description: '<div style="line-height: 1.7;"><p style="margin-bottom: 12px;">Set the billing discount to control user charges.</p><div style="padding: 8px 12px; background: #fef3c7; border-left: 3px solid #f59e0b; border-radius: 4px; font-size: 13px; margin-bottom: 12px;"><b>⚙️ Billing Rules:</b><ul style="margin: 8px 0 0 16px;"><li><b>1.0</b> - Original price (cost price)</li><li><b>1.5</b> - User consumes 1U, charged 1.5U</li><li><b>2.0</b> - User consumes 1U, charged 2U</li><li><b>0.8</b> - Subsidy mode (loss-making)</li></ul></div><p style="font-size: 13px; color: #6b7280;">Recommend setting test group to 1.0</p></div>',
        nextBtn: 'Next'
      },
      groupExclusive: {
      ...
      keyGroup: {
        ...
        description: '<div style="line-height: 1.7;"><p style="margin-bottom: 12px;">Select the group you just configured.</p><div style="padding: 8px 12px; background: #eff6ff; border-left: 3px solid #3b82f6; border-radius: 4px; font-size: 13px; margin-bottom: 12px;"><b>📌 Group Determines:</b><ul style="margin: 8px 0 0 16px;"><li>Which accounts this key can use</li><li>What billing discount applies</li><li>Whether it\'s an exclusive key</li></ul></div><p style="padding: 8px 12px; background: #f0fdf4; border-left: 3px solid #10b981; border-radius: 4px; font-size: 13px;"><b>💡 Tip:</b> Select the test group you just created</p></div>',
        nextBtn: 'Next'
      },
      keySubmit: {
