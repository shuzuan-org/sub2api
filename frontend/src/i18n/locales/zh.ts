export default {
  ...
  keys: {
    ...
    quotaLimit: '额度限制',
    quotaAmount: '额度金额 (U)',
    quotaAmountPlaceholder: '输入额度限制（U）',
  ...
  admin: {
    ...
    users: {
      ...
      // 用户分组配置
      groupConfig: '用户分组配置',
      groupConfigHint: '为用户 {email} 配置专属分组折扣（覆盖分组默认折扣）',
    ...
    groups: {
      ...
      form: {
        ...
        rateMultiplierLabel: '折扣',
        rateMultiplierHint: '1.0 = 原价，0.5 = 五折',
        exclusiveLabel: '专属分组',
      ...
      exclusiveTooltip: {
        ...
        example: '使用场景：',
        exampleContent:
          '公开分组折扣 0.8，您可以创建一个折扣 0.7 的专属分组，手动分配给 VIP 用户，让他们享受更优惠的价格。'
      },
      rateMultiplierHint: '1.0 = 原价，0.5 = 五折',
      platforms: {
        all: '全部平台',
      ...
      saving: '保存中...',
      noGroups: '暂无分组',
      noGroupsDescription: '创建分组以更好地管理 API 密钥和折扣。',
      ...
      rateMultipliers: '专属折扣',
      rateMultipliersTitle: '分组专属折扣管理',
      addUserRate: '添加用户专属折扣',
      searchUserPlaceholder: '搜索用户邮箱...',
      noRateMultipliers: '暂无用户设置了专属折扣',
      rateUpdated: '专属折扣已更新',
      rateDeleted: '专属折扣已删除',
      rateAdded: '专属折扣已添加',
      clearAll: '全部清空',
      confirmClearAll: '确定要清空该分组所有用户的专属折扣设置吗？此操作不可撤销。',
      rateCleared: '已清空所有专属折扣',
      batchAdjust: '批量调整折扣',
      multiplierFactor: '乘数',
      applyMultiplier: '应用',
      rateAdjusted: '折扣已批量调整',
      rateSaved: '专属折扣已保存',
      finalRate: '最终折扣',
    ...
    settings: {
      ...
      registration: {
        ...
        frontendUrlHint: '系统公网访问地址，用于生成邮件密码重置链接、支付宝异步回调等。必须是公网可达的 https URL，例如 https://example.com',
        totp: '双因素认证 (2FA)',
    ...
    sms: {
      title: '腾讯云短信',
      description: '配置腾讯云短信服务用于手机号验证码',
      smsTencentEnabled: '启用短信服务',
      smsTencentEnabledHint: '开启后允许用户通过手机号接收验证码',
      smsTencentSecretId: 'SecretId',
      smsTencentSecretIdPlaceholder: '请输入腾讯云 SecretId',
      smsTencentSecretKey: 'SecretKey',
      smsTencentSecretKeyPlaceholder: '请输入腾讯云 SecretKey',
      smsTencentSecretKeyHint: '已配置，留空则不修改',
      smsTencentRegion: '地域',
      smsTencentRegionPlaceholder: 'ap-guangzhou',
      smsTencentSdkAppId: 'SDK App ID',
      smsTencentSdkAppIdPlaceholder: '请输入短信应用 ID',
      smsTencentSignName: '签名名称',
      smsTencentSignNamePlaceholder: '请输入短信签名',
      smsTencentTemplateId: '模板 ID',
      smsTencentTemplateIdPlaceholder: '请输入短信模板 ID',
      tabs: {
        registration: '注册设置',
        smtp: 'SMTP',
        turnstile: 'Turnstile',
  ...
  userSubscriptions: {
    ...
    purchaseFailed: '购买失败',
    insufficientBalanceRecharge: '余额不足，请及时充值',
    dailyLimit: '每日额度',
    weeklyLimit: '每周额度',
    monthlyLimit: '每月额度',
    validity: '有效期',
  ...
  onboarding: {
    ...
    admin: {
      ...
      groupManage: {
        title: '📦 第一步：分组管理',
        description:
          '<div style="line-height: 1.7;"><p style="margin-bottom: 12px;"><b>什么是分组？</b></p><p style="margin-bottom: 12px;">分组是 Sub2API 的核心概念，它就像一个"服务套餐"：</p><ul style="margin-left: 20px; margin-bottom: 12px; font-size: 13px;"><li>🎯 每个分组可以包含多个上游账号</li><li>💰 每个分组有独立的计费折扣</li><li>👥 可以设置为公开或专属分组</li></ul><p style="margin-top: 12px; padding: 8px 12px; background: #f0fdf4; border-left: 3px solid #10b981; border-radius: 4px; font-size: 13px;"><b>💡 示例：</b>您可以创建"VIP专线"（高折扣）和"免费试用"（低折扣）两个分组</p><p style="margin-top: 16px; color: #10b981; font-weight: 600;">👉 点击左侧的"分组管理"开始</p></div>'
      },
      createGroup: {
        title: '➕ 创建新分组',
        description:
      ...
      groupMultiplier: {
        title: '💰 3. 折扣',
        description:
          '<div style="line-height: 1.7;"><p style="margin-bottom: 12px;">设置该分组的计费折扣，控制用户的实际扣费。</p><div style="padding: 8px 12px; background: #fef3c7; border-left: 3px solid #f59e0b; border-radius: 4px; font-size: 13px; margin-bottom: 12px;"><b>⚙️ 计费规则：</b><ul style="margin: 8px 0 0 16px;"><li><b>1.0</b> - 原价计费（成本价）</li><li><b>1.5</b> - 用户消耗 1U，扣除 1.5U</li><li><b>2.0</b> - 用户消耗 1U，扣除 2U</li><li><b>0.8</b> - 补贴模式（亏本运营）</li></ul></div><p style="font-size: 13px; color: #6b7280;">建议测试分组设置为 1.0</p></div>',
        nextBtn: '下一步'
      },
      groupExclusive: {
        title: '🔒 4. 专属分组（可选）',
      ...
      keyGroup: {
        title: '🎯 2. 选择分组',
        description:
          '<div style="line-height: 1.7;"><p style="margin-bottom: 12px;">选择刚才配置好的分组。</p><div style="padding: 8px 12px; background: #eff6ff; border-left: 3px solid #3b82f6; border-radius: 4px; font-size: 13px; margin-bottom: 12px;"><b>📌 分组决定：</b><ul style="margin: 8px 0 0 16px;"><li>该密钥可以使用哪些账号</li><li>计费折扣是多少</li><li>是否为专属密钥</li></ul></div><p style="padding: 8px 12px; background: #f0fdf4; border-left: 3px solid #10b981; border-radius: 4px; font-size: 13px;"><b>💡 提示：</b>选择刚才创建的测试分组</p></div>',
        nextBtn: '下一步'
      },
      keySubmit: {
        title: '🎉 生成并复制',
